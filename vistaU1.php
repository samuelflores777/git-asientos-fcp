...
<header></header>
 <section class="main">
    ...
    <form action="vistaU1.php" method = "POST">
    ...
    <?php
        ...
        while ($filas = mysqli_fetch_array($resultado)){ ?>
            <tr>
                    ...
                    <td>
                        <div class="ref1">
                        <a href="eliminarA.php?id=<?php echo $filas['id'];?>">ELIMINAR</a>
                        </div>
                    </td>
            </tr>
        <?php }?>
