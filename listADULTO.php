    ...
    <H3>TOTAL REGISTRADOS SON: <?= $row;?> </H3>
                ...
                <TABLE id="cuadro">
                        ...
                        <TR>
                            ...
                            <td><div class="ref1"><a href="elimLA.php?id=<?php echo $filas['id'];?>">ELIMINAR</a></div></td>
                            <td><div class="ref1"><a href="listADULTOedit.php?id=<?php echo $filas['id'];?>">EDITAR</a></div></td>
